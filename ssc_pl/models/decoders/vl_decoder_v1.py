...
class VisionLanguageDecoderV1(nn.Module):
    ...
    def __init__(self,
        ...
        self.cls_head = nn.Sequential(nn.Linear(embed_dims + num_classes, num_classes))
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            if (self.training and i == 0) or i == len(self.layers) - 1:
                ...
                ssc_logit = self.cls_head(torch.cat([vox_feats, inner_prod_logit], dim=1).permute(0, 2, 3, 4, 1)).permute(0, 4, 1, 2, 3)
                outs.append(ssc_logit)
        return outs
